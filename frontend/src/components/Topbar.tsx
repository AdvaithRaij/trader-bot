...
export function Topbar({ 
  ...
  return (
    <header className={cn("glass border-b border-white/10 px-3 sm:px-4 md:px-6 py-3 md:py-4 overflow-hidden", className)}>
      <div className="flex items-center justify-between min-w-0 gap-2 sm:gap-4 flex-wrap">
        {/* Left Side */}
